...
//I believe this adds a listener to the window object, which hides the setup page and game page when the window loads
window.addEventListener("load", function () {
  var setupPageElement = document.getElementById("setupPage");
  setupPageElement.style.display = "none";
  var gamePageElement = document.getElementById("gamePage");
